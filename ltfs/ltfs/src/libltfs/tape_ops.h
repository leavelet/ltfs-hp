...
#define TC_LOGPAGE_DTD_STATUS      (0x11)   /* Log page of DTD Status  */
#define TC_LOGPAGE_DTD_STATUS_SIZE (16)
#define TC_DTD_STATUS_OFFSET       (10) 
#define TC_DTD_STATUS_CALIBRATING  (11)     /* Value which denotes cartridge initialization in progress */
